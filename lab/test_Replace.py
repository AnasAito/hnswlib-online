...
hnsw_index.init_index(max_elements=max_num_elements,
                      ef_construction=200, M=16, allow_replace_deleted=True)
...
# Note: maximum number of elements is reached
hnsw_index.add_items(data2, labels2)
...
hnsw_index.knn_query(data2, k=10)
